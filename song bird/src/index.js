...
console.log("все выполнено согласно требований. вместо галлереи птиц реализован поиск фотографий птиц из викторины с использованием API википедии, Flickr, Google.")
