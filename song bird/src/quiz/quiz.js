...
import rightAnswerFile from '../assets/sound/right-answer.ogg';
import wrongAnswerFile from '../assets/sound/wrong-answer.mp3';
...
let hiddenBird;
const rightAnswerSound = new Audio(rightAnswerFile);
const wrongAnswerSound = new Audio(wrongAnswerFile);
